const login = (user, password) =>{
  ...
  it('Sprawdzanie zakładki start', ()=> {
    ...
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dt:nth-child(1)').should('exist').contains('Description lists');
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dd:nth-child(2)').should('exist').contains('A description list is perfect for defining terms.');
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dt:nth-child(3)').should('exist').contains('Euismod');
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dd:nth-child(4)').should('exist').contains('Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.');
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dd:nth-child(5)').should('exist').contains('Donec id elit non mi porta gravida at eget metus.');
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dd:nth-child(6)').should('exist').contains('Malesuada porta');
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dd:nth-child(7)').should('exist').contains('Etiam porta sem malesuada magna mollis euismod.');
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dd:nth-child(8)').should('exist').contains('Felis euismod semper eget lacinia');
    cy.get('#app > main > div > div:nth-child(2) > div > dl > dd:nth-child(9)').should('exist').contains('Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.');
